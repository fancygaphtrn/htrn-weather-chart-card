...
renderMain({ config, sun, weather, temperature, feels_like, description } = this) {
  ...
  return x$1`
    <div class="main">
      ...
      <div>
        <div>
          ${showTemperature ? x$1`${roundedTemperature}<span>${this.getUnit('temperature')}</span>` : ''}
